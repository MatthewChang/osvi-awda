from robosuite_mosaic.utils.placement_samplers import UniformRandomSampler
import collections
import numpy as np
from robosuite_mosaic.utils import RandomizationError
from robosuite_mosaic.utils.transform_utils import quat_multiply
from robosuite_mosaic.models.objects import MujocoObject

from copy import copy

class BoundarySampler(UniformRandomSampler):
    def __init__(
        self,
        name,
        mujoco_objects=None,
        ...
        self.additional_dist = addtional_dist
                ...
                if self.ensure_valid_placement:
                    for (x, y, z), _, other_obj in placed_objects.values():
                        if (
                                ...
                                <= other_obj.horizontal_radius + horizontal_radius + self.additional_dist
                        ) and (
