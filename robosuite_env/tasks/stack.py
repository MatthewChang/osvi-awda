from robosuite_mosaic.environments.manipulation.stack import Stack as DefaultStack
import sys
...
from robosuite_mosaic.models.objects import BoxObject, CylinderObject
